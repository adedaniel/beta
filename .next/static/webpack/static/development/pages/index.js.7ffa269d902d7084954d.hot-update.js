...
function ErrorPage(props) {
  return __jsx("div", {
    ...
    strings: ["Please check your internet connection and reload"],
    typeSpeed: 30,
    startDelay: 1000,
    cursorChar: '',
    __source: {
